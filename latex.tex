...
\begin{lstlisting}
\titleformat{\subsubsection}{%
  \filcenter\bfseries\large\color{cadmiumorange}}
...
To go from section numbering 0.0.1 to just 1, put this in the preamble:
\begin{lstlisting}
\usepackage{titlesec}
\titleformat{\section}%
  [hang]% <shape>
...
...
\end{lstlisting}
This reference may have been for numbering subsections when sections have
no number\ldots don't remember.
