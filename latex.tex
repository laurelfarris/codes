...
The \verb|hyperref| package is required to make clickable links in toc.
...
\end{lstlisting}
where n = 2 for double spacing, 1 for single, 0.75 for compress.
...
\singlespacing
\end{lstlisting}
For sections only (not sure what I mean by that...)
